...
test_assert(version.sdk_version == "1.0.0", "SDK version from source/sdk/version.hpp (§38)")
test_assert(version.abi_version == "1", "module ABI version from source/sdk/version.hpp (§38)")
